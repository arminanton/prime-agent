...
export const MODELS = {
	...
	"github-copilot": {
		"claude-fable-5": {
			...
			headers: {"User-Agent":"copilot/1.0.81-6","Editor-Version":"copilot/1.0.81-6","Editor-Plugin-Version":"copilot/1.0.81-6","Copilot-Integration-Id":"copilot-developer-cli"},
			reasoning: true,
			thinkingLevelMap: {"off":null,"xhigh":"xhigh","max":"max"},
			input: ["text", "image"],
			cost: {
